...
# =====================================================
# NORMALIZAÇÃO DE STATUS E SETOR_ATUAL
# =====================================================
df_proc["status"] = df_proc["status"].astype(str).str.strip().str.title()
df_proc["setor_atual"] = df_proc["setor_atual"].astype(str).str.strip().str.title()
