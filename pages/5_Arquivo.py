...
def carregar_csv_github(caminho, colunas=None):
    """Lê CSV direto do GitHub e retorna DataFrame"""
    try:
        arquivo = repo.get_contents(caminho, ref=BRANCH)
...
df_users = carregar_csv_github(CAMINHO_USUARIOS, colunas=["usuario","perfil","setor"])
...
df_setores_destino = carregar_csv_github(CAMINHO_SETOR_DESTINO)

# =====================================================
# PROCESSOS JÁ DESTINADOS (TABELA)
# =====================================================
if not df_dest.empty:
    ...
    st.dataframe(
        df_encaminhados[["numero_protocolo","numero_referencia","setor_origem","destino","data_saida"]]
        .rename(columns={
